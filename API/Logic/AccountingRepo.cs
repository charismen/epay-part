...
namespace Plexform.Base.Accounting.Repo
{
    public class AccountingSCHEDULEHDR : BaseRepository<DTO.Questil.Contract.SCHEDULEHDR>
    {
        public AccountingSCHEDULEHDR(IWebHostEnvironment env, string connectionString) : base(env, connectionString) { }
    }
    ...
    #region PAYMENT
    public class PAYMENT : BaseRepository<dynamic>
    {
        public PAYMENT(IWebHostEnvironment env, string connectionString) : base(env, connectionString) { }
    }
    #endregion PAYMENT
    
    #region SYSCODEB
    public class SYSCODEB : BaseRepository<DTO.Accounting.SYSCODEB>
    {
        public SYSCODEB(IWebHostEnvironment env, string connectionString) : base(env, connectionString) { }
    }
    #endregion

    #region INVOICEHDR
    public class INVOICEHDR : BaseRepository<DTO.Accounting.INVOICEHDR>
    {
        public INVOICEHDR(IWebHostEnvironment env, string connectionString) : base(env, connectionString) { }
    }
    #endregion
    
    #region INVOICEDTL
    public class INVOICEDTL : BaseRepository<DTO.Accounting.INVOICEDTL>
    {
        public INVOICEDTL(IWebHostEnvironment env, string connectionString) : base(env, connectionString) { }
    }
    #endregion

    #region INVOICETAX
    public class INVOICETAX : BaseRepository<DTO.Accounting.INVOICETAX>
    {
        public INVOICETAX(IWebHostEnvironment env, string connectionString) : base(env, connectionString) { }
    }
    #endregion

    #region TRANSHDR
    public class TRANSHDR : BaseRepository<DTO.Accounting.TRANSHDR>
    {
        public TRANSHDR(IWebHostEnvironment env, string connectionString) : base(env, connectionString) { }
    }
    #endregion

    #region TRANSDTL
    public class TRANSDTL : BaseRepository<DTO.Accounting.TRANSDTL>
    {
        public TRANSDTL(IWebHostEnvironment env, string connectionString) : base(env, connectionString) { }
    }
    #endregion

    #region TRANSFPX
    public class TRANSFPX : BaseRepository<DTO.Accounting.TRANSFPX>
    {
        public TRANSFPX(IWebHostEnvironment env, string connectionString) : base(env, connectionString) { }
    }
    #endregion

    #region TRANSTENDER
    public class TRANSTENDER : BaseRepository<DTO.Accounting.TRANSTENDER>
    {
        public TRANSTENDER(IWebHostEnvironment env, string connectionString) : base(env, connectionString) { }
    }
    #endregion

    #region TENDER
    public class TENDER : BaseRepository<DTO.Accounting.TENDER>
    {
        public TENDER(IWebHostEnvironment env, string connectionString) : base(env, connectionString) { }
    }
    #endregion

    #region TRANSCDHDR
    public class TRANSCDHDR : BaseRepository<DTO.Accounting.TRANSCDHDR>
    {
        public TRANSCDHDR(IWebHostEnvironment env, string connectionString) : base(env, connectionString) { }
    }
    #endregion

    #region TRANSCDITEM
    public class TRANSCDITEM : BaseRepository<DTO.Accounting.TRANSCDITEM>
    {
        public TRANSCDITEM(IWebHostEnvironment env, string connectionString) : base(env, connectionString) { }
    }
    #endregion

    //#region TRANSCASHBILLHDR
    //public class TRANSCASHBILLHDR : BaseRepository<DTO.Accounting.TRANSCASHBILLHDR>
    //{
    //    public TRANSCASHBILLHDR(IWebHostEnvironment env, string connectionString) : base(env, connectionString) { }
    //}
    //#endregion

    //#region TRANSCASHBILLDTL
    //public class TRANSCASHBILLDTL : BaseRepository<DTO.Accounting.TRANSCASHBILLDTL>
    //{
    //    public TRANSCASHBILLDTL(IWebHostEnvironment env, string connectionString) : base(env, connectionString) { }
    //}
    //#endregion

    //#region TRANSCDNHDR
    //public class TRANSCDNHDR : BaseRepository<DTO.Accounting.TRANSCDNHDR>
    //{
    //    public TRANSCDNHDR(IWebHostEnvironment env, string connectionString) : base(env, connectionString) { }
    //}
    //#endregion

    //#region TRANSCDNDTL
    //public class TRANSCDNDTL : BaseRepository<DTO.Accounting.TRANSCDNDTL>
    //{
    //    public TRANSCDNDTL(IWebHostEnvironment env, string connectionString) : base(env, connectionString) { }
    //}
    //#endregion

    #region PROCTASK
    public class PROCTASK : BaseRepository<DTO.Accounting.PROCTASK>
    {
        public PROCTASK(IWebHostEnvironment env, string connectionString) : base(env, connectionString) { }
    }
    #endregion

    #region INVOICEHDR_OLD
    public class INVOICEHDR_OLD : BaseRepository<DTO.Accounting.INVOICEHDR_OLD>
    {
        public INVOICEHDR_OLD(IWebHostEnvironment env, string connectionString) : base(env, connectionString) { }
    }
    #endregion


    #region INVOICEITEM
    public class INVOICEITEM : BaseRepository<DTO.Accounting.INVOICEITEM>
    {
        public INVOICEITEM(IWebHostEnvironment env, string connectionString) : base(env, connectionString) { }
    }
    #endregion
