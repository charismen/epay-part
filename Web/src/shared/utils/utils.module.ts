...
import * as CustomPipe from '@shared/common/pipes/custom.pipe';
...
@NgModule({
    ...
    providers: [
        ...
        CustomPipe.RemovewhitespacesPipe,
        CustomPipe.SplitPipe,
        CustomPipe.FileSizePipe,
        CustomPipe.ReplacePipe,
        CustomPipe.GenerateRandomCode
    ],
    declarations: [
        EqualValidator,
