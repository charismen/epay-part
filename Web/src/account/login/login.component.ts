...
import { RegistrationModalComponent } from './lgm-registration-modal.component';
...
export class LoginComponent extends AppComponentBase implements OnInit {
    @ViewChild('registrationModal', { static: false }) registrationModal: RegistrationModalComponent;
