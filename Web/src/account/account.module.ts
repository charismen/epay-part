...
import { RegistrationModalComponent } from './login/lgm-registration-modal.component';
import { AppFormModule } from './../app/shared/form/app-form.module';
import { ResponseComponent } from './response/response.component';
import { PaymentResponseComponent } from './response/payment-response.component';
import { RegisterEmailComponent } from './register-activation/registerEmail.component';
import { ConfirmRegisterEmailComponent } from './register-activation/confirm-registerEmail.component';
import { TableModule } from 'primeng/table';
import { ReceiptComponent } from './response/receipt.component';
