...
export class AppPreBootstrap {
    ...
    private static getApplicationConfig(appRootUrl: string, callback: () => void) {
        ...
        XmlHttpRequestHelper.ajax(type, url, customHeaders, null, (result) => {
            ...
            AppConsts.appCurrency = result.appCurrency;

            AppConsts.DownloadText = result.DownloadText;
            AppConsts.Stimulsoft = result.Stimulsoft;
            AppConsts.FPX = result.FPX;
            AppConsts.MayBank = result.MayBank;

            AppConsts.isUAT = result.isUAT;
